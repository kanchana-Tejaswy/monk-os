      ...
      <div className="w-full max-w-md space-y-12 animate-in fade-in zoom-in duration-1000 flex flex-col items-center">
        ...
        <div className="w-full monk-card p-8 space-y-6">
          ...
          <button 
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white text-black font-bold py-4 rounded-xl hover:scale-[1.02] transition-all shadow-lg active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed border border-gray-200"
          >
            {loading ? (
